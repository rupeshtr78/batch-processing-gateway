...
import com.apple.rupesh.notary.client.NotaryClient;
import com.apple.rupesh.notary.openapi.model.ApiIssueTokenBody;
import com.apple.rupesh.notary.openapi.model.ApiIssueTokenResp;
...
public class AppleNotaryUtil {
    ...
    public static void enableNotaryEnvironmentVariable(
        ...
        String notary_token = generateNotaryToken(sparkApplicationResource);
    ...
    public static String generateNotaryToken(SparkApplicationResource sparkApplicationResource) {
...
//          use the actor authority token to get an actor token identity_aprn for actor required as input
            ...
            String sparkJobIdentityAprn = String.format("aprn:apple:rupesh::bpg-rtr-test:task:%s", sparkApplicationID);
